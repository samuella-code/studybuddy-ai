  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.content}>
        ...
        <View style={styles.sectionHeader}><Text variant="titleMedium" style={styles.sectionTitle}>Today&apos;s focus</Text><Text style={styles.percent}>0%</Text></View>
...
const styles = StyleSheet.create({
  ...
  title: { fontWeight: "800", marginTop: 16 }, subtitle: { opacity: 0.68, lineHeight: 22, marginBottom: 8 }, hero: { borderRadius: 24, marginBottom: 8 }, heroTitle: { fontWeight: "800", marginBottom: 8 }, heroText: { opacity: 0.72, lineHeight: 22, marginBottom: 18 }, primaryButton: { borderRadius: 14, alignSelf: "flex-start" }, buttonContent: { paddingVertical: 5, paddingHorizontal: 8 }, sectionHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 8 }, sectionTitle: { fontWeight: "700", marginTop: 8 }, percent: { opacity: 0.65, marginTop: 8 }, progress: { height: 8, borderRadius: 8, marginTop: 4 }, helper: { opacity: 0.6, fontSize: 13 }, chips: { flexDirection: "row", flexWrap: "wrap", gap: 8, marginTop: 4 }, chip: { marginBottom: 2 }, grid: { flexDirection: "row", flexWrap: "wrap", gap: 12, marginTop: 8 }, toolCard: { flex: 1, minWidth: 220, borderRadius: 18 }, statCard: { flex: 1, minWidth: 160, borderRadius: 18 }, statLabel: { opacity: 0.65, marginTop: 4 },
});
