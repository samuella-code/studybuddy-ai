      ...
      <View style={styles.content}>
        ...
        <Card style={styles.hero} mode="contained">
          <Card.Content>
            ...
            <Text style={styles.heroText}>
              Ask questions, get simple explanations, and practice until it clicks.
            </Text>
            <Button
              mode="contained"
              icon="microphone"
        ...
        <View style={styles.chips}>
          {subjects.map((subject) => (
            <Chip key={subject} icon="book-open-variant" style={styles.chip}>
              {subject}
            </Chip>
          ))}
          <Chip icon="plus" onPress={() => {}} style={styles.chip}>Add subject</Chip>
        </View>
